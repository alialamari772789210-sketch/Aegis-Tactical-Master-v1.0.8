...
// ==============================================================================
// [البنية الأساسية الموحدة]: أرقام وإصدارات وهياكل البيانات التكتيكية لـ Liquid-DSP
// ==============================================================================
#define LIQUID_VERSION "1.5.0"

// أنواع البيانات الطيفية المركبة والمصفوفات المعتمدة عتادياً لبناء الإشارات
